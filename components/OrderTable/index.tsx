  ...
  const renderFilters = () => (
    <React.Fragment>
      <FormControl size="sm">
        ...
        >
          <Option value="paid">Postado</Option>
          <Option value="pending">Fila</Option>
   ...
   const formatarData = (dataString) => {
     ...
     const formatadorDeData = new Intl.DateTimeFormat(
       "pt-BR",
       opcoesDeFormatacao
     )
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ width: 280, padding: "12px 6px" }}>Título</th>
              <th style={{ width: 140, padding: "12px 6px" }}>Preço</th>
              <th style={{ width: 140, padding: "12px 6px" }}>Data</th>
              <th style={{ width: 140, padding: "12px 6px" }}>Status</th>
              <th style={{ width: 90, padding: "12px 6px" }}>Usuário</th>
              <th style={{ width: 140, padding: "12px 6px" }}> </th>
            </tr>
          </thead>
          <tbody>
            {stableSort(products, getComparator(order, "id")).map((product) => (
              <tr key={product.id}>
                ...
                <td>
                  <Typography level="body-xs">Anônimo</Typography>
                </td>
                <td>
                  <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
